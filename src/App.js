...
function App() {
    ...
    return (
            ...
            <
            div className = {
                (typeof weather.main != "undefined") ? ((weather.main.temp > 14) ? 'app warm' : 'app') : 'app'
            } >
...

            {
                (typeof weather.main != "undefined") ? (
                ...
                ) : ( < p className = "message" > Please enter a city name to get its weather < /p>)}</div >
                    ...
                    <
                    form className = "search-box-wiki"
...

                    {
                        wikipedia.map((result) => {
                            ...
                            return ( < div className = "wiki-result" >
